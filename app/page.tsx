...
export default function Page() {
  const [brief, setBrief] = useState<Brief>(DRAFT_BRIEF)
      ...
      <div className="page-wrap">
        <section className="page-heading">
          <div>
            ...
            <p>
              Edit the brief, then hand it over. The coach looks for assumptions your team has already
              tested.
            </p>
          </div>
          <button className="quiet-button" type="button">
            <MoreHorizontal size={17} /> Options
          </button>
        </section>
